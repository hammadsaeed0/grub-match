...
import { ICONS, COLORS, wp, hp } from '../../constant';
	...
	const styles = StyleSheet.create({
		...
		message: {
			...
			fontFamily:'Poppins-Medium', fontSize:15,
			 color: status==="success"? COLORS.black: COLORS.white, textTransform:'capitalize', lineHeight: 18,  letterSpacing: 0.16
		},
							...
							{status === 'warning' ?
								...
								: status === 'error' ?
									...
									<ICONS.MaterialIcons
										...
										color={status==="success"?COLORS.black: COLORS.white}
										size={30} />}
						</View>
